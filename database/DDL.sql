...
CREATE OR REPLACE TABLE Outfits (
...
CREATE OR REPLACE TABLE Bottoms (
...
CREATE OR REPLACE TABLE Jackets (
  jacket_id int NOT NULL AUTO_INCREMENT,
  user_id int NOT NULL,
  name varchar (100) NOT NULL,
  type varchar (100) NOT NULL,
  color varchar (100) NOT NULL, 
...
CREATE OR REPLACE TABLE Accessories (
...
CREATE OR REPLACE TABLE Occasions (
...
CREATE OR REPLACE TABLE OutfitsAccessories (
  outfit_acc_id int NOT NULL AUTO_INCREMENT,
  outfit_id int NOT NULL,
  accessory_id int NOT NULL,
  PRIMARY KEY (outfit_acc_id),
...
CREATE OR REPLACE TABLE OutfitsOccasions (
  outfit_occ_id int NOT NULL AUTO_INCREMENT,
  outfit_id int NOT NULL,
  occasion_id int NOT NULL,
  PRIMARY KEY (outfit_occ_id),
  FOREIGN KEY (outfit_id) REFERENCES Outfits(outfit_id)
  ON DELETE CASCADE,
